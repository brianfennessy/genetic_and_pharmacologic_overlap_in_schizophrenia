...
# LOAD - Targets
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
tar <- unique(fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/targets/drugbank_seachange_targets_final.tsv"))
...
# Save
save(mymtx_ap, file="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/ap_significant_targets_drugbank_only.Rdata")

# Check that it loads
# load("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/ap_significant_targets_drugbank_only.Rdata")
...
# Save
save(mymtx_pp_all, file="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_all_significant_targets_drugbank_only.Rdata")

# Check that it loads
# load("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_all_significant_targets_drugbank_only.Rdata")
...
# Save
save(mymtx_pp_int, file="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_int_significant_targets_drugbank_only.Rdata")

# Check that it loads
# load("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_int_significant_targets_drugbank_only.Rdata")
...
# Save
save(mymtx_pp_no_cns, file="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_no_cns_significant_targets_drugbank_only.Rdata")

# Check that it loads
# load("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_no_cns_significant_targets_drugbank_only.Rdata")
...
# Write out
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fwrite(pp_all_sig_targs, sep="\t", "./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/propsychotic_significant_targets_all_drugbank_only.tsv")
fwrite(pp_int_sig_targs, sep="\t", "./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/propsychotic_significant_targets_int_drugbank_only.tsv")
fwrite(ap_sig_targs, sep="\t", "./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/antipsychotic_significant_targets_drugbank_only.tsv")
fwrite(pp_no_cns_sig_targs, sep="\t", "./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/propsychotic_significant_targets_no_cns_drugbank_only.tsv")
