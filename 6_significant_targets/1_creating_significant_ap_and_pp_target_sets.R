...
# LOAD - Targets
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
tar <- unique(fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/targets/drugbank_seachange_targets_final.tsv")[,.(rxcui,drug_name,gene)])
...
# Save
save(mymtx_ap, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/ap_significant_targets.Rdata")

# Check that it loads
# load("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/ap_significant_targets.Rdata")
...
# Save
save(mymtx_pp_all, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_all_significant_targets.Rdata")

# Check that it loads
# load("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_all_significant_targets.Rdata")
...
# Save
save(mymtx_pp_int, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_int_significant_targets.Rdata")

# Check that it loads
# load("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_int_significant_targets.Rdata")
...
# Save
save(mymtx_pp_no_cns, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_no_cns_significant_targets.Rdata")

# Check that it loads
# load("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_no_cns_significant_targets.Rdata")
...
# Write out
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fwrite(pp_all_sig_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_all.tsv")
fwrite(pp_int_sig_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_int.tsv")
fwrite(ap_sig_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/antipsychotic_significant_targets.tsv")
fwrite(pp_no_cns_sig_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_no_cns.tsv")
