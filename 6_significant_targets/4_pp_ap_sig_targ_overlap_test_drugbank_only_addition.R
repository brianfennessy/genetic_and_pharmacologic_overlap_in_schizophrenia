...
no_cns_drugs <- unique(fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/antipsychotics/atc_rxnorm_mapped.tsv")[,.(rxcui,drug_name,level1_description)])
...
pp_all_sig_targs_drugbank_only <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/propsychotic_significant_targets_all_drugbank_only.tsv")
pp_int_sig_targs_drugbank_only <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/propsychotic_significant_targets_int_drugbank_only.tsv")
...
fwrite(final, sep="\t", "./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/mapped_files/significant_targets/pp_ap_overlap_significance_drugbank_only.tsv")
