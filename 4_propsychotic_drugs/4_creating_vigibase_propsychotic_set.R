...
# Load VigiBase
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
vgb <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/vigibase_single_drug_and_statistical_thresholds.tsv")
...
# Load MedDRA
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
meddra <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/meddra_psychosis.tsv")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
sdr_master <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/sider_original.tsv")
...
# Write out
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fwrite(vgb_pp_final, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/vigibase_propsychotics_all_information.tsv")
fwrite(vgb_pp_final_w_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/vigibase_propsychotics_all_information_with_targets.tsv")
fwrite(vgb_pp_all, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/vigibase_propsychotics_drugs_only.tsv")
fwrite(vgb_pp_w_targs, sep="\t", "/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/vigibase_propsychotics_drugs_with_targets_only.tsv")
