...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  library(data.table)
  library("XML", lib.loc="/hpc/packages/minerva-common/rpackages/3.5.1/site-library")
  library(foreach)
  library(parallel)
  library(doMC)
  options(cores = parallel:::detectCores())
  registerDoMC(15)
  setwd("/sc/arion/projects/psychgen/methods/rx/files/drugbank_id_harmonization")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  tmp_data = xmlParse("/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/full_database.xml")
  dbx = xmlToList(tmp_data)
  #save(dbx, file="/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/full_database.Rdata")
  #load("/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/full_database.Rdata")

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# parse the scraped html files that contain some mappings not in the full drugbank release
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  my.fil = list.files(pattern="DB*")
  ...
  #save(found, file="/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/hiddenDBIDmatches.Rd")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  # save(dt, file="/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/full_database_IDharmonization.Rdata")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ##given = fread("/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_ALT_IDS.rrf", header=F)[,.(id1=V1, id2=V2, meth="drugbank")] 
  ##matches = rbind(matches, given)
  ##write.table( matches, row=F, quo=F, file="/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/dbid_matches.tsv", sep="\t" ) 
