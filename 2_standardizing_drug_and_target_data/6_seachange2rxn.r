...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  scd0 = fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_binding_cfp_1-13-14.csv",    header=T,sep=",", na.strings="NULL")[ , Pvalue := 10^log10_Pvalue ][, seachange_method := "binding_cfp"] 
  scd1 = fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_binding_path_1-13-14.csv",   header=T,sep=",", na.strings="NULL")[ , Pvalue := 10^log10_Pvalue ][, seachange_method := "binding_path"]
  scd2 = fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_functional_cfp_1-13-14.csv", header=T,sep=",", na.strings="NULL")[ , Pvalue := 10^log10_Pvalue ][, seachange_method := "functional_cfp"] 
  scd3 = fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_functional_path_1-13-14.csv",header=T,sep=",", na.strings="NULL")[ , Pvalue := 10^log10_Pvalue ][, seachange_method := "functional_path"] 
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  chembl2pc = fread('./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/chembl/src1src22.txt', header=T, col.names=c("chembl_id","intermediate_id"))
  chembl2db = fread('./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/chembl/src1src2.txt' , header=T, col.names=c("chembl_id","intermediate_id"))
  chembl2unii = fread('./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/chembl/src1src14.txt', header=T, col.names=c("chembl_id","intermediate_id"))
...
# save
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  save(sc2rxn, file="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_id_map_sc2rxn.Rd")
