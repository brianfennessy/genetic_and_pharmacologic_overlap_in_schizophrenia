...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  setwd("/sc/arion/projects/psychgen/methods/rx/data/side_effects/sider4.1/")
...
# stitch 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  stitch4.fil = '/sc/arion/projects/psychgen/methods/rx/data/stitch/chemical.sources.v4.0.tsv'
  stitch4.fl2 = '/sc/arion/projects/psychgen/methods/rx/data/stitch/chemicals.inchikeys.v4.0.1.tsv'
...
# umls 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  uml = "/sc/arion/projects/psychgen/methods/rx/data/umls/2016AB/installation1/2016AB/META/"
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  pc2uniiUC = fread('/sc/arion/projects/psychgen/methods/rx/data/stitch/src14src22.txt', header=T, col.names = c("unii","pubchem"), sep='\t' )
  pc2uniiPC = fread('/sc/arion/projects/psychgen/methods/rx/data/stitch/pc2unii.txt', header=T, col.names = c("unii","pubchem"), sep='\t' )
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  pcie_in = '/sc/arion/projects/psychgen/methods/rx/data/pcie/input/siderPC_st4.txt'
  pcie_out = '/sc/arion/projects/psychgen/methods/rx/data/pcie/output/OUT_siderPC.txt'
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ## pubchem <> ndf
  pc2ndf = fread('/sc/arion/projects/psychgen/methods/rx/files/pc_compound_type.ttl.reformatted', sep='\t', header=F) [V1!="",c(1,3),with=F]
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  ## rxn <> smiles
  pcieR_in = '/sc/arion/projects/psychgen/methods/rx/data/pcie/input/rxn2smil2pc.txt'
  pcieR_out = '/sc/arion/projects/psychgen/methods/rx/data/pcie/output/OUT_rxn2smil2pc.txt'
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  stitch4 = fread('/sc/arion/projects/psychgen/methods/rx/data/stitch/chemicals.v4.0.tsv', header=T, sep='\t')
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  # save(sdr2rxn, file="/sc/arion/projects/psychgen/methods/rx/files/drug_id_map_sdr2rxn.Rd")
