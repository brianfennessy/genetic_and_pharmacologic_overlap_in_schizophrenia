...
# load vigibase
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  my.vb = load_vigibase(path="./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/side_effects/vigibase/VigiBase_Extract_Case_Level_2017_Sep_1", date="sep_1_2017", filelist=c("ddx","drug","ind","link","out", "srce", "demo", "followup")) 
  drug = my.vb$drug
  ind = my.vb$ind
  ddx = my.vb$ddx
  link = my.vb$link
