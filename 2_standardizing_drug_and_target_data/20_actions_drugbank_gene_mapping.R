...
# Load targets
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
target_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/target-all-uniprot-links.csv"
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
dt1_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_AA_SEQ.rrf"
dt1 <- fread(dt1_path)[,.(db_gene=V9,uniprot=V6)]
dt1 <- unique(dt1)

dt2_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_SYN.rrf"
dt2 <- fread(dt2_path)[,.(db_gene=V5,uniprot=V2)]
dt2 <- unique(dt2)

dt3_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_EXT_IDS.rrf"
dt3 <- fread(dt3_path)[,.(db_gene=V6,uniprot=V3)]
dt3 <- unique(dt3)

dt4_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_EXT_IDS.rrf"
dt4 <- fread(dt4_path)[,.(db_gene=V6,uniprot=V3)]
dt4 <- unique(dt4)

dt5_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_GO_CLASSIFIERS.rrf"
dt5 <- fread(dt5_path)[,.(db_drug=V7,db_gene=V6,uniprot=V3,mechanism=V2)]
dt5 <- unique(dt5)

dt6_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_PFAMS.rrf"
dt6 <- fread(dt6_path)[,.(db_gene=V6,uniprot=V3)]
dt6 <- unique(dt6)

dt7_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGET_POLYPEPTIDES.rrf"
dt7 <- fread(dt7_path, sep="|", fill=TRUE)

dt8_path <- "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/DRUGBANK_DRUG_TARGETS_GENE_SEQ.rrf"
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
dbkmap <- fread("/sc/arion/projects/psychgen/methods/rx/files/drugbank_uniprot_id_map.tsv", na="", col.names = c("uniprot","gene","gene_other")) 
...
# Question for Alex and Doug: Can I use that website to make my own list of uniprot to gene name? If so, how, becuase when I tried it didn't work
# Website: https://www.uniprot.org/uploadlists/
# Issue: It couldnt find information on the DB gene ID's (i.e. BE0000048 returns "Sorry, no results were found.")
...
# Write out
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fwrite(final, sep="\t", "/sc/arion/projects/psychgen/methods/rx/data/drug_target/drugbank/5.1.1/dbgeneid2uni.tsv")
