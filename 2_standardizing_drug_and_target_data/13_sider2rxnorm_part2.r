...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  sdr = fread("/sc/arion/projects/psychgen/methods/rx/data/side_effects/sider4.1/sider_awcQC.txt",  header=T, sep='\t')
  sdr.ind = fread("/sc/arion/projects/psychgen/methods/rx/data/side_effects/sider4.1/sider_ind_awcQC.txt", header=T, sep='\t')
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  ...
  # save(mysdr, file="/sc/arion/projects/psychgen/methods/rx/data/side_effects/sider4.1/mysdr.Rdata")
  ...
  # write.table(mytab, row=F, quo=F, sep="\t", file="/sc/arion/projects/psychgen/methods/rx/data/side_effects/sider4.1/mysdr_final_map.tsv")
