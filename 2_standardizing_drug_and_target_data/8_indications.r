...
# indications
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  sdr.ind = unique(fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/side_effects/sider4.1/meddra_all_indications.tsv", na=c("","NA"), header=F)[!is.na(V6),.(sider.stitchF=V1, sider.meddra_name_umls=V6)])
