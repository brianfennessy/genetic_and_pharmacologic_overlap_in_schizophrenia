...
load("/sc/arion/projects/psychgen/methods/rx/files/drug_id_map_db2rxn_2020.Rd")
...
# LOAD - RxNorm
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
rxn <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/propsychotics/rxnorm_refined.tsv", sep="\t")
...
seamap <- fread("/sc/arion/projects/psychgen/methods/rx/files/seachange_uniprot_id_map.tsv", na="", col.names = cnames)
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
fwrite(final_w_gene_other, row=F, quo=F, sep="\t", file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/targets/drugbank_seachange_targets_with_gene_other.tsv")
fwrite(final_simplified, row=F, quo=F, sep="\t", file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/targets/drugbank_seachange_targets_final.tsv")
