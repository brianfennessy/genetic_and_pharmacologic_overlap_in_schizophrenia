...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
scd0 <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_binding_cfp_1-13-14.csv", header=T,sep=",", na.strings="NULL")
scd1 <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_binding_path_1-13-14.csv", header=T,sep=",", na.strings="NULL")
scd2 <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_functional_cfp_1-13-14.csv", header=T,sep=",", na.strings="NULL")
scd3 <- fread("./genetic_and_pharmacologic_overlap_in_schizophrenia-main/1_inhouse_functions_and_setup/raw_data/drug_target/seachange/SeaChange_SC_functional_path_1-13-14.csv",header=T,sep=",", na.strings="NULL")
