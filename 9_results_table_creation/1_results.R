...
# Load 
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
vgb_med_qc <- unique(fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/qc_pp_drugs_meddra_descriptions.tsv")[,.(rxcui,drug_name,adverse_event=pt_name)])
vgb_med_qc_plus <- unique(fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/qc_plus_pp_drugs_meddra_descriptions.tsv")[,.(rxcui,drug_name,adverse_event=pt_name)])

vgb_atc_qc <- unique(fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/qc_pp_drugs_atc_descriptions.tsv")[,.(rxcui,drug_name,drug_type=level3_description)])
vgb_atc_qc_plus <- unique(fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/qc_plus_pp_drugs_atc_descriptions.tsv")[,.(rxcui,drug_name,drug_type=level3_description)])
...
# vgb_med_qc_counts <- vgb_med_qc[,.N,pt_name]
# vgb_med_qc_counts[,prop_qc := N/uniqueN(vgb_med_qc[,.(rxcui,pt_code)])]

# # Optional (counts if we don't want to collapse)
# vgb_med_qc_plus_counts <- vgb_med_qc_plus[,.N,pt_name]
# vgb_med_qc_plus_counts[,prop_qc_plus := N/uniqueN(vgb_med_qc_plus[,.(rxcui,pt_code)])]
...
# # Optional (counts if we don't want to collapse)
# vgb_atc_qc_counts <- vgb_atc_qc[,.N,level3_description]
# vgb_atc_qc_counts[,prop_qc := N/uniqueN(vgb_atc_qc[,.(rxcui,level3_description)])]

# # Optional (counts if we don't want to collapse)
# vgb_atc_qc_plus_counts <- vgb_atc_qc_plus[,.N,level3_description]
# vgb_atc_qc_plus_counts[,prop_qc_plus := N/uniqueN(vgb_atc_qc_plus[,.(rxcui,level3_description)])]
...
#
# ==================================================================================================================================================================
sheet3 <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/ap_drugs.tsv")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_pp_targs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_all.tsv")[,.(gene,total_prop_db_and_sc=total_prop,observed_prop_qc_pp=observed_prop,p_value_qc_pp=p_value)]
uniqueN(qc_pp_targs_sig[p_value_qc_pp < 0.05,]$gene) # [1] 169

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# QC+ Propsychotics targets (significant) - DrugBank and SeaChange
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_plus_pp_targs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_int.tsv")[,.(gene,total_prop_db_and_sc=total_prop,observed_prop_qc_plus_pp=observed_prop,p_value_qc_plus_pp=p_value)]
uniqueN(qc_plus_pp_targs_sig[p_value_qc_plus_pp < 0.05,]$gene) # [1] 118

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Antipsychotics targets (significant) - DrugBank and SeaChange
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ap_targs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/antipsychotic_significant_targets.tsv")[,.(gene,total_prop_db_and_sc=total_prop,observed_prop_ap=observed_prop,p_value_ap=p_value)]
uniqueN(ap_targs_sig[p_value_ap < 0.05,]$gene) # [1] 129

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# No CNS Propsychotics targets (significant) - DrugBank and SeaChange
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
no_cns_pp_targs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_no_cns.tsv")[,.(gene,total_prop_db_and_sc=total_prop,observed_prop_no_cns_pp=observed_prop,p_value_no_cns_pp=p_value)]
uniqueN(no_cns_pp_targs_sig[p_value_no_cns_pp < 0.05,]$gene) # [1] 118

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# QC Propsychotics targets (significant) - DrugBank only
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_pp_targs_sig_drugbank_only <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_all_drugbank_only.tsv")[,.(gene,total_prop_db_only=total_prop,observed_prop_qc_pp_drugbank_only=observed_prop,p_value_qc_pp_drugbank_only=p_value)]
uniqueN(qc_pp_targs_sig_drugbank_only[p_value_qc_pp_drugbank_only < 0.05,]$gene) # [1] 86

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# QC+ Propsychotics targets (significant) - DrugBank only
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_plus_pp_targs_sig_drugbank_only <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_int_drugbank_only.tsv")[,.(gene,total_prop_db_only=total_prop,observed_prop_qc_plus_pp_drugbank_only=observed_prop,p_value_qc_plus_pp_drugbank_only=p_value)]
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ap_targs_sig_drugbank_only <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/antipsychotic_significant_targets_drugbank_only.tsv")[,.(gene,total_prop_db_only=total_prop,observed_prop_ap_drugbank_only=observed_prop,p_value_ap_drugbank_only=p_value)]
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
no_cns_pp_targs_sig_drugbank_only <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/propsychotic_significant_targets_no_cns_drugbank_only.tsv")[,.(gene,total_prop_db_only=total_prop,observed_prop_no_cns_pp_drugbank_only=observed_prop,p_value_no_cns_pp_drugbank_only=p_value)]
...
#
# ==================================================================================================================================================================
sheet5 <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_targets/pp_ap_overlap_significance_drugbank_only.tsv")
...
# Load mechanism data
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
mech <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/targets/drugbank_seachange_targets_with_actions.tsv")
...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_pp_mechs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_mechanisms/propsychotic_significant_mechanisms_all.tsv")[,.(gene_mech,observed_prop_qc_pp=observed_prop,p_value_qc_pp=p_value)]
uniqueN(qc_pp_mechs_sig) # [1] 164

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Load QC+ Propsychotics mechs (both significant and non significant)
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
qc_plus_pp_mechs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_mechanisms/propsychotic_significant_mechanisms_int.tsv")[,.(gene_mech,observed_prop_qc_plus_pp=observed_prop,p_value_qc_plus_pp=p_value)]
uniqueN(qc_plus_pp_mechs_sig) # [1] 116

# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
# Load antipsychotics mechs (both significant and non significant)
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
ap_mechs_sig <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/significant_mechanisms/antipsychotic_significant_mechanisms.tsv")[,.(gene_mech,observed_prop_ap=observed_prop,p_value_ap=p_value)]
...
#
# ==================================================================================================================================================================
sheet8 <- fread("/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/sz_targets/enrichment_results.tsv")
...
write.xlsx(sheet1, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="QC Propsychotic Drugs", row.names=FALSE, append=TRUE)
write.xlsx(sheet2, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="QC+ Propsychotic Drugs", row.names=FALSE, append=TRUE)
write.xlsx(sheet3, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="Antipsychotic Drugs", row.names=FALSE, append=TRUE)
write.xlsx(sheet4, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="Target Proportions", row.names=FALSE, append=TRUE)
write.xlsx(sheet5, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="Overlapping Targets", row.names=FALSE, append=TRUE)
write.xlsx(sheet6, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="Mechanism Proportions", row.names=FALSE, append=TRUE)
write.xlsx(sheet7, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="Targets and Mechanisms", row.names=FALSE, append=TRUE)
write.xlsx(sheet8, file="/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx", sheetName="SCZ Variant Enrichment", row.names=FALSE, append=TRUE)

# Swing to local
# scp cottel02@chimera.hpc.mssm.edu:/sc/arion/projects/psychgen/methods/rx/psychosis_paper_2021/paper_tables/scz_drug_targets_paper_tables.xlsx /Users/Liam/Desktop/
